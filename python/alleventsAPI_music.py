# -*- coding: utf-8 -*-
"""
Created on Fri Mar 10 11:49:13 2017
...
music_json = music.decode('utf-8')
# convert python object to json strings
music_dict = json.loads(music_json)
print(music_dict['count'])

with open('rm_music_2003_2703_pg0.json', 'w') as f:
